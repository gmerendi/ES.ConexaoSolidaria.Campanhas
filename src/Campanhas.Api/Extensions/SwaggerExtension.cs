    ...
    public static class SwaggerExtension
    {
        public static IServiceCollection AddSwaggerConfiguration(this IServiceCollection services, ILogger logger)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "ONG Esperança Solidária - Conexao Solidaria - Campanhas.API ",
                    Version = "V.1.0.0",
                    Description = "## Tech Challenge - Fase 5\nMVP da plataforma digital Conexao solidaria. Esta API gerencia campanhas e doacoes.",
        ...
        public static IApplicationBuilder UseSwaggerMiddleware(this IApplicationBuilder app, ILogger logger)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("v1/swagger.json", "Conexao Solidaria - Campanhas.Api");
